    ...
    <div class="main-container">
        ...
        <table>
            ...
            <tr>
                ...
                <td v-else style="color: red">NULL</td>
            </tr>
            </tbody>
        </table>
...
const reset = async () => {
    a.value = ["", "", "", "", "", "", "", "", "", ""]
    await post("/api/link-game/historical-record/reset", store.auth.user.username)
}

onMounted(async () => {
    a.value = await post("/api/link-game/historical-record", store.auth.user.username)
})
</script>
